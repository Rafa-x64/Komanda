    ...
    <div class="finance-container p-4 main-content">
      <header class="row mb-4 align-items-center">
        <div class="col-12 col-md-6">
          <h2 class="fw-bold mb-1 text-primary-custom">Control de <span class="text-korange">Caja y Finanzas</span></h2>
          <p class="text-secondary-custom small">Turno Actual: <strong>Mañana</strong> | Responsable: {{ userName }}</p>
        </div>
        <div class="col-12 col-md-6 text-md-end d-flex gap-2 justify-content-md-end">
          <button @click="registrarEgreso" class="btn-outline-korange rounded-pill px-3">
            <i class="bi bi-dash-circle me-2"></i>Egreso Rápido
          </button>
          <button @click="toggleCaja"
            :class="['btn rounded-pill px-4 shadow-sm', cajaAbierta ? 'btn-danger' : 'btn-success']">
        ...
        <div class="col-12 col-md-4">
          <div class="card kpi-finance  shadow-sm border-start border-korange border-4">
            <div class="card-body">
              ...
              <small class="text-secondary-custom">Efectivo + Tarjetas + Digital</small>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-4">
        ...
        <div class="col-12 col-md-4">
          <div class="card kpi-finance  shadow-sm">
            <div class="card-body">
              ...
              <small class="text-secondary-custom">Tickets de venta legal</small>
            </div>
          </div>
        </div>
      </div>
